...
class Basic_Bot(Bot):
    def __init__(self, jeu, x, y, id):
        ...
        self.image = pg.image.load("assets/images/enemy/basic_bot.png").convert_alpha()
        coef = 2.5
...
class Drone_Bot(Bot, others.Animation):
    def __init__(self, jeu, x, y, id):
        super().__init__(jeu, x, y, id, vie = 25, degats=10, vitesse= 0.15, portee = 0, cadence = 0.25, name="Drone_Bot")
        coef = 3
        self.animation = others.Animation(8, "enemy/drone_frames/frame_", x, y, (22*coef, 28*coef))
